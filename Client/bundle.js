...
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('form',[_c('div',{staticClass:"form-group"},[_c('input',{staticClass:"form-control",attrs:{"type":"email","id":"login","aria-describedby":"emailHelp","placeholder":"Логин"}})]),_vm._v(" "),_c('div',{staticClass:"form-group"},[_c('input',{staticClass:"form-control",attrs:{"type":"password","id":"password","placeholder":"Пароль"}})]),_vm._v(" "),_c('div',{staticClass:"form-group"},[_c('input',{staticClass:"form-control",attrs:{"type":"password","id":"Repeat password","placeholder":"Повтор пароля"}})]),_vm._v(" "),_c('button',{staticClass:"btn btn-primary",attrs:{"type":"submit","id":"button"}},[_vm._v("Зарегистрироваться!")])])])}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d7ee5d6c", __vue__options__)
  } else {
    hotAPI.reload("data-v-d7ee5d6c", __vue__options__)
  }
})()}
